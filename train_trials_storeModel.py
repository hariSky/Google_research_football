...
while not target_reached and iters < max_iters:
    ...
    for itr in range(ppo_steps):
        ...
        if state[87+7]!=0:
        	reward=reward+(state[87+1]*0.1+0.1) 
    ...
    if iters % 5 == 0:
	    ...
	    model_actor.save('model_actor_{}.hdf5'.format(iters, avg_reward),save_format='tf')
	    model_critic.save('model_critic_{}.hdf5'.format(iters, avg_reward))
    iters += 1
    env.reset()
