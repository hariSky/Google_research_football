...
def get_model_actor_extracted(input_dims, output_dims, n_actions):
    ...
    x = Conv2D(64, kernel_size=(8, 8),padding="valid", kernel_initializer="glorot_uniform",bias_initializer='zeros',  activation='relu', input_shape=input_dims, name='1Conv', strides=(4,4))(state_input)
    #x = BatchNormalization(axis=3)(x)
    x = Conv2D(64, kernel_size=(8, 8),  kernel_initializer="glorot_uniform", bias_initializer='zeros', activation='relu', name='2Conv', strides=(4,4))(x)
