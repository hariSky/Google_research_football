...
while not target_reached and iters < max_iters:
    ...
    if iters % 20 == 0 and iters!=0:
	    ...
	    if avg_reward > best_reward:
	        ...
	        model_actor.save('model_actor_11_vs_11_easy_stochastic_extracted__5{}_{}.hdf5'.format(iters, avg_reward))
	        model_critic.save('model_critic_11_vs_11_easy_stochastic_extracted__5{}_{}.hdf5'.format(iters, avg_reward))
	        best_reward = avg_reward
	    if best_reward > 0.9 or iters > max_iters:
	        target_reached = True
	    
	    
	    model_actor.save('model_actor_11_vs_11_easy_stochastic_extracted__5{}.hdf5'.format(iters),save_format='tf')
	    model_critic.save('model_critic_11_vs_11_easy_stochastic_extracted__5{}.hdf5'.format(iters))
    iters += 1
    env.reset()
